...
public class YearViewPOAdapter extends RecyclerView.Adapter<YearViewPOAdapter.ViewHolder> {
    Context context;
    ArrayList<Temporarymodel> itemList = new ArrayList<>();
    int type;
    ChangeLayout changeLayout;

    public YearViewPOAdapter(Context context, ArrayList<Temporarymodel> itemList, int type, ChangeLayout changeLayout) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        YearViewPOAdapter.ViewHolder viewHolder = new YearViewPOAdapter.ViewHolder(view);
...
//        float cost = 0;
        holder.count.setText("" + model.getPurchaseCount() + " purchases");
        holder.cost.setText("Cost: Rs " + CommonUtils.getFormattedPrice(model.getTotalCost()));
        holder.purchase.setText("Purchase: Rs " + CommonUtils.getFormattedPrice(model.getTotalPurchaseCost()));
