...
public class VendorProductsAdapter extends RecyclerView.Adapter<VendorProductsAdapter.ViewHolder> {
    Context context;
    ...
    public VendorProductsAdapter(Context context, ArrayList<Product> productList, OnProductStatusChanged productStatusChanged) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.vendor_product_item_layout, parent, false);
...
//        holder.retailPrice.setText("Rs. " + model.getRetailPrice()+"\nRetail Price");
        ...
        if (model.getSellerProductStatus() != null) {
...
//                }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView title, subtitle, wholesalePrice, retailPrice, vendorName;
