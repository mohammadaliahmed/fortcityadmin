...
public class SellerOrdersFragment extends Fragment {
    ...
    public SellerOrdersFragment(String orderStatus, String by) {
...
//        progress = rootView.findViewById(R.id.progress);
        ...
        adapter = new SellerOrdersAdapter(context, arrayList, new SellerOrdersAdapter.UpdateOrderStatus() {
            @Override
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (model != null) {
                            if (model.getOrderStatus().equalsIgnoreCase(orderStatus)) {
                                if (model.getOrderFor() != null && model.getOrderFor().equalsIgnoreCase("Seller")) {
                                    arrayList.add(model);
