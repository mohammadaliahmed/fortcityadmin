...
import com.appsinventiv.toolsbazzaradmin.Activities.CategoryPackage.MainCategoryAdapter;
...
public class AddMainAttributes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_main_attributes);
        this.setTitle("Add Main Attributes");
        ...
        adapter = new MainAttributesAdapter(this, itemList, 1, new MainAttributesAdapter.MainAttributesCallBacks() {
            @Override
        ...
        pickImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mSelected.clear();
                Matisse.from(AddMainAttributes.this)
    ...
    private void showAlert(final MainCategoryModel model) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddMainAttributes.this);
    ...
    private void uploadData() {
        mDatabase.child("Settings/Attributes/MainAttributes").child(mainCategories.getText().toString())
        ...
        riversRef.putFile(file)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        mDatabase.child("Settings/Attributes/MainAttributes").child(key).child("url").setValue("" + downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                mainCategories.setText("");
                                subCategories.setText("");
                                Glide.with(AddMainAttributes.this).load(R.drawable.photo).into(pickImage);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data != null) {
            if (requestCode == REQUEST_CODE_CHOOSE) {
                ...
                Glide.with(AddMainAttributes.this).load(mSelected.get(0)).into(pickImage);
                for (Uri img : mSelected) {
                    CompressImage compressImage = new CompressImage(AddMainAttributes.this);
